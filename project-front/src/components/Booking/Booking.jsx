...
// import Swal from 'sweetalert2';
// import { AuthContext } from '../../context/AuthContext';
// import PaymentGateway from '../Payment/PaymentGateway'; // Assuming PaymentGateway is in the same directory
...
//     // Handle payment method (e.g., store in state, send to server, etc.)
//     setPaymentMethod(paymentMethod);
//     setShowPaymentGateway(false); // Hide payment gateway after successful payment
//     // You can add further logic here, such as sending the booking details to your server
//     // and handling the booking confirmation process
//     showAlert();
//   };
...
//             <TextField id="guestSize" label="No. Of Guests" variant="standard" onChange={handleChange} type='text' error={errors.guestSize} helperText={errors.guestSize && "Number of guests is required"} className='form-control' required disabled={!user} />
//           </FormGroup>
//           <Button as={Link} to='./payment' type="submit" className='btn primary__btn w100 mt-4 form-control' >
//             Book Now
//           </Button>
//         </Form>
//       </div>
...
//       {showPaymentGateway && (
//         <PaymentGateway
//           totalAmount={calculateCharges().total}
